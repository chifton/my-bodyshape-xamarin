...
namespace MyBodyShape.Android.Listeners
{
    ...
    public class SideMoveImageRunnable : Java.Lang.Object, IRunnable
    {
        ...
        /// The constructor.
        /// </summary>
        public SideMoveImageRunnable(ViewImageView.View fragmentView, Handler repeatedHandler, ImageButton currentButton, Canvas canvas, Paint paint, Paint pathPaint, float radius, List<CircleArea> circlesList, List<PathArea> pathList)
        {
